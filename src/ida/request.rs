...
impl_request_inspection!(
    Open, Close, LoadDebugInfo, AnalysisStatus, ListFunctions,
    ResolveFunction, DisasmByName, Disasm, Decompile, Segments,
    Strings, LocalTypes, DeclareType, ApplyTypes, InferTypes,
    AddrInfo, FunctionAt, DisasmFunctionAt, DeclareStack, DeleteStack,
    StackFrame, Structs, StructInfo, ReadStruct, XRefsTo,
    XRefsFrom, XRefsToField, Imports, Exports, Entrypoints,
    GetBytes, SetComments, Rename, PatchBytes, PatchAsm,
    BasicBlocks, Callees, Callers, IdbMeta, LookupFunctions,
    ListGlobals, AnalyzeStrings, FindString, XrefsToString, AnalyzeFuncs,
    FindBytes, SearchText, SearchImm, FindInsns, FindInsnOperands,
    ReadInt, GetString, GetGlobalValue, FindPaths, CallGraph,
    XrefMatrix, ExportFuncs, PseudocodeAt, RunScript,
    RenameLvar, SetLvarType, SetDecompilerComment,
);
